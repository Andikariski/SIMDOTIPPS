@props(['title' => '', 'size' => 'modal-sm', 'closable' => true, 'show' => false, 'closeHandler' => null])

<div x-data="{ show: @js($show) }" x-show="show" x-transition:enter="transition ease-out duration-100"
