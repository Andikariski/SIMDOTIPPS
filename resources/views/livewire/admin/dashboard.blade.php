      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card text-center">
          <div class="card-body">
            ...
            <h2 class="fw-bold text-primary count-up" data-target="128">20</h2>
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card text-center">
          <div class="card-body">
            ...
            <h2 class="fw-bold text-success count-up" data-target="452">35</h2>
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card text-center">
          <div class="card-body">
            ...
            <h2 class="fw-bold text-warning count-up" data-target="36">40</h2>
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="card text-center">
          <div class="card-body">
            ...
            <h2 class="fw-bold text-danger count-up" data-target="14">30</h2>
