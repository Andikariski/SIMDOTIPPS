...
<div>
    ...
    @if ($status === 'Buka')
        <div class="alert alert-success  alert-dismissible fade show" role="alert">
            <i class="bi bi-exclamation-diamond" style="font-size: 18px; color:rgb(0, 185, 46)"></i>
            <span class="badge bg-success">TERBUKA</span> Akses perubahan RAP sudah terbuka.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    @elseif($status === 'Tutup')    
        <div class="alert alert-danger  alert-dismissible fade show" role="alert">
            <i class="bi bi-exclamation-diamond" style="font-size: 18px; color:rgb(208, 0, 0)"></i>
            <span class="badge bg-danger">TERKUNCI</span> Akses perubahan RAP telah terkunci.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    @endif
    <div class="mt-5">
       <div class="row align-items-center mb-3 mt-4">
            ...
            @if ($status === 'Buka')
                <button wire:click="toggleStatus" wire:loading.attr="disabled"
                    ...
                    <span wire:loading.remove>Kunci Akses</span>
